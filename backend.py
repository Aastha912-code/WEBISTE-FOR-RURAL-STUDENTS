...
app.config['MYSQL_PASSWORD'] = os.getenv('MYSQL_PASSWORD', 'AA12@****')  # Use env variable for security
...
def send_otp(receiver_email, otp):
    sender_email = "agarwal*****a**@gmail.com"
    sender_password = "ppee vipb **ip **jn"  # App Password from Google
